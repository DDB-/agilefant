...
INSERT INTO `history_backlogs` VALUES (1,0,8,5,'2012-01-15 23:33:24',2),(2,0,10,7,'2012-01-16 10:15:56',2),(3,0,14,11,'2012-01-16 15:33:20',2),(4,0,14,11,'2012-01-17 13:18:17',2),(5,0,12,9,'2012-01-25 17:12:16',2),(6,0,18,15,'2012-01-27 15:59:30',2),(7,0,24,21,'2012-01-27 19:36:29',2),(8,0,24,21,'2012-02-01 18:49:05',2),(9,0,22,19,'2012-02-03 16:06:31',2),(10,6,22,19,'2012-02-04 17:38:47',2),(11,0,22,19,'2012-02-06 19:31:03',2);
...
INSERT INTO `history_iterations` VALUES (1,0,0,0,'2012-01-16',3),(2,0,0,0,'2012-01-25',3),(3,0,0,0,'2012-01-27',3),(4,0,0,0,'2012-02-03',3),(5,1860,360,1860,'2012-02-04',3),(6,0,360,1860,'2012-02-06',3),(7,240,660,2100,'2012-02-11',3),(8,0,720,2100,'2012-02-21',3),(9,0,600,2100,'2012-02-25',3),(10,0,540,2100,'2012-02-28',3);
...
INSERT INTO `settings` VALUES (1,'Agilefant database version','AgilefantDatabaseVersion','205'),(2,NULL,'RangeLow','0'),(3,NULL,'RangeHigh','120'),(4,NULL,'OptimalLow','70'),(5,NULL,'OptimalHigh','85'),(6,NULL,'CriticalLow','100'),(7,NULL,'HourReporting','true'),(8,NULL,'DevPortfolio','true'),(9,NULL,'DailyWork','true'),(10,NULL,'StoryTreeFieldOrder','state,storyPoints,labels,name,breadcrumb,backlog'),(11,NULL,'branchMetricsType','estimate'),(12,NULL,'labelsInStoryList','true'),(13,NULL,'weekendsInBurndown','true');
...
INSERT INTO `stories` VALUES (1,NULL,'Learn How To Agilefant',1,3,1,2,NULL),(2,NULL,'Make a Sub-Story',1,3,0,2,1),(3,NULL,'Another sub story',1,3,1,2,1),(4,NULL,'New Story',0,2,2,2,NULL),(5,'Seeing if we can get it replicated','Replicating B ug',6,2,3,3,NULL),(6,'This story should count towards the total','Unblocked Story',2,4,4,3,NULL),(7,'This is another test story so that this iteration slowly gets bigger over time.','The Third Story',3,4,5,3,NULL),(8,'No relation to the movie made by Michael \"Crappy Movies\" Bay','I am Number Four',1,6,6,3,NULL);
...
INSERT INTO `stories_AUD` VALUES (1,2,0,NULL,'Learn How To Agilefant',0,NULL,1,1,NULL),(1,4,1,NULL,'Learn How To Agilefant',0,3,1,1,NULL),(1,11,1,NULL,'Learn How To Agilefant',1,3,1,1,NULL),(1,13,1,NULL,'Learn How To Agilefant',1,3,1,2,NULL),(1,47,1,NULL,'Learn How To Agilefant',5,3,1,2,NULL),(1,48,1,NULL,'Learn How To Agilefant',1,3,1,2,NULL),(2,3,0,NULL,'Make a Sub-Story',0,NULL,0,1,1),(2,7,1,NULL,'Make a Sub-Story',0,3,0,1,1),(2,10,1,NULL,'Make a Sub-Story',1,3,0,1,1),(2,13,1,NULL,'Make a Sub-Story',1,3,0,2,1),(3,5,0,NULL,'Another sub story',0,NULL,1,1,1),(3,6,1,NULL,'Another sub story',0,3,1,1,1),(3,9,1,NULL,'Another sub story',1,3,1,1,1),(3,13,1,NULL,'Another sub story',1,3,1,2,1),(4,15,0,NULL,'New Story',0,NULL,2,1,NULL),(4,16,1,NULL,'New Story',0,2,2,1,NULL),(4,17,1,NULL,'New Story',0,2,2,2,NULL),(5,21,0,'Seeing if we can get it replicated','Replicating B ug',0,2,3,3,NULL),(5,23,1,'Seeing if we can get it replicated','Replicating B ug',3,2,3,3,NULL),(5,25,1,'Seeing if we can get it replicated','Replicating B ug',2,2,3,3,NULL),(5,26,1,'Seeing if we can get it replicated','Replicating B ug',3,2,3,3,NULL),(5,27,1,'Seeing if we can get it replicated','Replicating B ug',1,2,3,3,NULL),(5,28,1,'Seeing if we can get it replicated','Replicating B ug',3,2,3,3,NULL),(5,29,1,'Seeing if we can get it replicated','Replicating B ug',0,2,3,3,NULL),(5,30,1,'Seeing if we can get it replicated','Replicating B ug',3,2,3,3,NULL),(5,31,1,'Seeing if we can get it replicated','Replicating B ug',6,2,3,3,NULL),(5,32,1,'Seeing if we can get it replicated','Replicating B ug',2,2,3,3,NULL),(5,33,1,'Seeing if we can get it replicated','Replicating B ug',6,2,3,3,NULL),(5,34,1,'Seeing if we can get it replicated','Replicating B ug',1,2,3,3,NULL),(5,49,1,'Seeing if we can get it replicated','Replicating B ug',6,2,3,3,NULL),(6,24,0,'This story should count towards the total','Unblocked Story',1,4,4,3,NULL),(6,50,1,'This story should count towards the total','Unblocked Story',2,4,4,3,NULL),(7,37,0,'This is another test story so that this iteration slowly gets bigger over time.','The Third Story',0,NULL,5,3,NULL),(7,38,1,'This is another test story so that this iteration slowly gets bigger over time.','The Third Story',2,NULL,5,3,NULL),(7,39,1,'This is another test story so that this iteration slowly gets bigger over time.','The Third Story',2,4,5,3,NULL),(7,46,1,'This is another test story so that this iteration slowly gets bigger over time.','The Third Story',3,4,5,3,NULL),(8,40,0,'No relation to the movie made by Michael \"Crappy Movies\" Bay','I am Number Four',0,NULL,6,3,NULL),(8,41,1,'No relation to the movie made by Michael \"Crappy Movies\" Bay','I am Number Four',0,3,6,3,NULL),(8,42,1,'No relation to the movie made by Michael \"Crappy Movies\" Bay','I am Number Four',0,6,6,3,NULL),(8,45,1,'No relation to the movie made by Michael \"Crappy Movies\" Bay','I am Number Four',1,6,6,3,NULL),(8,61,1,'No relation to the movie made by Michael \"Crappy Movies\" Bay','I am Number Four',5,6,6,3,NULL),(8,62,1,'No relation to the movie made by Michael \"Crappy Movies\" Bay','I am Number Four',1,6,6,3,NULL),(9,53,0,'Does it work','Story here for new shit',2,3,7,3,NULL),(9,54,2,'Does it work','Story here for new shit',2,3,7,3,NULL);
...
INSERT INTO `tasks` VALUES (1,NULL,120,'Task 1',120,1,0,NULL,5),(2,NULL,60,'A task to have',180,1,1,NULL,8),(3,NULL,360,'Something',360,1,0,NULL,7),(4,NULL,120,'A second task to do it',240,2,1,NULL,8),(5,NULL,0,'Third task in the record books',1320,3,1,NULL,8);
...
INSERT INTO `tasks_AUD` VALUES (1,22,0,NULL,NULL,'Task 1',NULL,1,0,NULL,5),(1,83,1,NULL,120,'Task 1',120,1,0,NULL,5),(2,51,0,NULL,180,'A task to have',180,1,1,NULL,8),(2,52,1,NULL,180,'A task to have',180,1,1,NULL,8),(2,56,1,NULL,0,'A task to have',180,1,5,NULL,8),(2,57,1,NULL,0,'A task to have',180,1,1,NULL,8),(2,60,1,NULL,180,'A task to have',180,1,1,NULL,8),(2,61,1,NULL,0,'A task to have',180,1,5,NULL,8),(2,63,1,NULL,0,'A task to have',180,1,1,NULL,8),(2,66,1,NULL,180,'A task to have',180,1,1,NULL,8),(2,67,1,NULL,180,'A task to have',180,1,4,NULL,8),(2,68,1,NULL,180,'A task to have',180,1,1,NULL,8),(2,69,1,NULL,120,'A task to have',180,1,1,NULL,8),(2,70,1,NULL,60,'A task to have',180,1,1,NULL,8),(2,71,1,NULL,0,'A task to have',180,1,5,NULL,8),(2,72,1,NULL,0,'A task to have',180,1,1,NULL,8),(2,75,1,NULL,120,'A task to have',180,1,1,NULL,8),(2,77,1,NULL,240,'A task to have',180,1,1,NULL,8),(2,78,1,NULL,120,'A task to have',180,1,1,NULL,8),(2,80,1,NULL,240,'A task to have',180,1,1,NULL,8),(2,81,1,NULL,240,'A task to have',180,1,1,NULL,8),(2,82,1,NULL,180,'A task to have',180,1,1,NULL,8),(2,84,1,NULL,0,'A task to have',180,1,1,NULL,8),(2,85,1,NULL,180,'A task to have',180,1,1,NULL,8),(2,86,1,NULL,60,'A task to have',180,1,1,NULL,8),(3,55,0,NULL,360,'Something',360,1,0,NULL,7),(4,58,0,NULL,NULL,'A second task to do it',NULL,2,0,NULL,8),(4,61,1,NULL,0,'A second task to do it',NULL,2,5,NULL,8),(4,64,1,NULL,0,'A second task to do it',0,2,1,NULL,8),(4,73,1,NULL,0,'A second task to do it',240,2,1,NULL,8),(4,74,1,NULL,0,'A second task to do it',240,2,1,NULL,8),(4,76,1,NULL,180,'A second task to do it',240,2,1,NULL,8),(4,79,1,NULL,180,'A second task to do it',240,2,1,NULL,8),(4,87,1,NULL,0,'A second task to do it',240,2,1,NULL,8),(4,88,1,NULL,180,'A second task to do it',240,2,1,NULL,8),(4,89,1,NULL,300,'A second task to do it',240,2,1,NULL,8),(4,90,1,NULL,120,'A second task to do it',240,2,1,NULL,8),(5,59,0,NULL,1320,'Third task in the record books',1320,3,0,NULL,8),(5,61,1,NULL,0,'Third task in the record books',1320,3,5,NULL,8),(5,65,1,NULL,0,'Third task in the record books',1320,3,1,NULL,8);
...
-- Dump completed on 2012-03-01  9:59:22
